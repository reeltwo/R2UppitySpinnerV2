...
/* Lifter Motor */
#define PIN_LIFTER_PWM1        5
#define PIN_LIFTER_PWM2        6
#define PIN_LIFTER_MEN         11
#define PIN_LIFTER_MENB        12
#define PIN_LIFTER_DIAG        A6

///////////////////////////////////
// --- Rotary mechanism

#define PIN_ROTARY_ENCODER_A   3
#define PIN_ROTARY_ENCODER_B   7

#define PIN_ROTARY_LIMIT       8

/* Rotary Motor */
#define PIN_ROTARY_PWM1        9
#define PIN_ROTARY_PWM2        10
#define PIN_ROTARY_MEN         13
#define PIN_ROTARY_MENB        A0
#define PIN_ROTARY_DIAG        A7
...
public:
    ...
    {
        digitalWrite(PIN_LIFTER_MEN, LOW);
        digitalWrite(PIN_LIFTER_MENB, HIGH);
        digitalWrite(PIN_ROTARY_MEN, LOW);
        digitalWrite(PIN_ROTARY_MENB, HIGH);
        fMotorsEnabled = false;
    }

    static void enableMotors()
    {
        digitalWrite(PIN_LIFTER_MEN, HIGH);
        digitalWrite(PIN_LIFTER_MENB, LOW);
        digitalWrite(PIN_ROTARY_MEN, HIGH);
        digitalWrite(PIN_ROTARY_MENB, LOW);
        fMotorsEnabled = true;
    ...
    {
        const auto output1{static_cast<uint8_t>(abs(v1) * 255)};
        const auto output2{static_cast<uint8_t>(abs(v2) * 255)};
